 ...
 * @author david
 */
public class VtnEPrincipal extends javax.swing.JFrame
{
...
//        this.setExtendedState(MAXIMIZED_BOTH);
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VtnEPrincipal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
